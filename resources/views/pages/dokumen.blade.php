...
<section class="bg-gray-50 min-h-screen py-10 px-4 md:px-10">
  <div class="max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
      @foreach([
        ['icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', 'count' => '45', 'label' => 'Total Dokumen'],
        ['icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'count' => '10', 'label' => 'Dokumen Keuangan'],
        ['icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2', 'count' => '15', 'label' => 'Peraturan Desa'],
        ['icon' => 'M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0', 'count' => '20', 'label' => 'Dokumen Perizinan'],
      ] as $stat)
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5" id="dokumen-grid">
      ...
      <div class="bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-all duration-300 dokumen-card">
        ...
        <div class="flex items-center gap-3 p-4">
          ...
          <div>
            <p class="text-xs text-gray-400 uppercase tracking-wide font-semibold">APBDES</p>
            <p class="text-sm font-bold text-blue-700 leading-snug">APBDes Tahun Anggaran 2026</p>
            <p class="text-xs text-gray-400 mt-0.5">1 Jan 2026</p>
          </div>
        </div>
        ...
        <div class="flex items-center justify-between px-4 py-3">
          <span class="text-xs text-gray-400">24 MB</span>
          <a href="#"
    ...
    <div class="flex items-center justify-between mt-8 text-xs text-gray-500">
      ...
      <div class="flex items-center gap-1">
        ...
        <button class="px-2.5 py-1 rounded hover:bg-gray-200">6</button>
        <button class="px-2.5 py-1 rounded hover:bg-gray-200">7</button>
        <button class="px-2.5 py-1 rounded hover:bg-gray-200">8</button>
        <button class="px-2.5 py-1 rounded hover:bg-gray-200">9</button>
        <span class="px-1">...</span>
        <button class="px-2.5 py-1 rounded hover:bg-gray-200">4079</button>
        <button class="px-2.5 py-1 rounded hover:bg-gray-200">4080</button>
        <button class="px-2 py-1 rounded hover:bg-gray-200 text-gray-400">&gt;</button>
      </div>
    </div>
